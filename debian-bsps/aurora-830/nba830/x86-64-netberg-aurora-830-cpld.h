#ifndef NETBERG_AURORA_830_I2C_CPLD_H
#define NETBERG_AURORA_830_I2C_CPLD_H
...
extern int aurora_830_cpld_read(u8 cpld_idx, u8 reg);
extern int aurora_830_cpld_write(u8 cpld_idx, u8 reg, u8 value);
